...
var Module = {
	...
	UE4_indexedDBName: 'UE4_assetDatabase_MyProject3', // this should be an ascii ID string without special characters that is unique to the project that is being packaged
	UE4_indexedDBVersion: 202307241252, // Bump this number to invalidate existing IDB storages in browsers.
};
...
Module.arguments = ['../../../MyProject3/MyProject3.uproject','-stdout',];
...
//	}
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/53d48pisw1x2yatia9m1o/MyProject3-HTML5-Shipping.wasm?rlkey=1zhvwq3tw6ljd0w1gokp1ep8r&dl=0'), 'arraybuffer').then(function(wasmBytes) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/rfqwafqowpue4msmdv1nl/MyProject3-HTML5-Shipping.data?rlkey=3lu541dl2hgh6h5hbwnx1r5v9&dl=0'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/almazufa/testue4/6c50501ceca731ede8c5d443952cc38125cfc0ab/MyProject3-HTML5-Shipping.data.js'));
...
// Instead as a fallback, download as ArrayBuffer. (TODO: Figure out the bugs with the above, and switch to using that one instead)
			fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com
https://dl.dropboxusercontent.com/scl/fi/rfqwafqowpue4msmdv1nl/MyProject3-HTML5-Shipping.data?rlkey=3lu541dl2hgh6h5hbwnx1r5v9&dl=0
'), 'arraybuffer').then(function(dataArrayBuffer) {
				Module['preloadedPackages'] = {};
				Module['preloadedPackages'][Module.locateFile('https://dl.dropboxusercontent.com
https://dl.dropboxusercontent.com/scl/fi/rfqwafqowpue4msmdv1nl/MyProject3-HTML5-Shipping.data?rlkey=3lu541dl2hgh6h5hbwnx1r5v9&dl=0
')] = dataArrayBuffer;
				return dataJsDownload.then(addScriptToDom);
			});
